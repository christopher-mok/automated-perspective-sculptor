...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self._target1_mask: np.ndarray | None = None  # float32 (H,W,1), black=foreground
        ...
        if step_idx == 1 or step_idx % 10 == 0:
            ...
            if isinstance(metrics, dict):
                print(
                    ...
                    f"terms(avg): view1_mask={metrics.get('view1_mask', metrics.get('view1_mse', 0.0)):.6f}, "
                    f"view2_target={metrics.get('view2_target', metrics.get('view2_loss', 0.0)):.6f}, "

...
7. Returns a metrics dictionary.
...
- Saves patches, cameras, targets, palette, learning rate, steps, run mode, threshold, temperature, schedule, loss mode, and device.
...
- A metrics dictionary with values such as total loss, view losses, overlap penalty, visibility penalty, edge-on penalty, and temperature.
...
- Computes overlap, visibility, and edge-on penalties.
